class Dustbin{
    constructor(x,y,width,height){
        this.bodyb=Bodies.rectangle(x, y, width, height, {isStatic:true});
        World.add(world,this.bodyb);
        this.bodyl=Bodies.rectangle((x-(width/2)), (y-(height*2)), height, width/2, {isStatic:true});
        World.add(world,this.bodyl);
        this.bodyr=Bodies.rectangle((x+(width/2)), (y-(height*2)), height, width/2, {isStatic:true});
